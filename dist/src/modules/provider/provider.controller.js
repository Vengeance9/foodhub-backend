...
const register = async (req, res) => {
    ...
    try {
        ...
        const result = await provider_services_1.providerServices.register(userId, providerData);
...
const getMyProviders = async (req, res) => {
    try {
        ...
        const result = await provider_services_1.providerServices.getMyProviders(userId, search);
        console.log(result);
...
const getProviderOrders = async (req, res) => {
    ...
    try {
        const result = await provider_services_1.providerServices.getProviderOrders(providerId);
...
const createMeal = async (req, res) => {
    try {
        ...
        const result = await provider_services_1.providerServices.createMeal(req.body, imageUrl, providerId, isAvailable);
...
const updateMeal = async (req, res) => {
    try {
        ...
        const result = await provider_services_1.providerServices.updateMeal(updatedData, mealId);
...
const deleteMeal = async (req, res) => {
    ...
    try {
        await provider_services_1.providerServices.deleteMeal(mealId, providerId);
...
const getAllProviders = async (req, res) => {
    try {
        const result = await provider_services_1.providerServices.getAllProviders();
        return res.status(200).json({ data: result, message: 'Providers fetched successfully' });
    }
    catch (e) {
...
const getProviderMeals = async (req, res) => {
    const providerId = req.params.id;
    try {
        const result = await provider_services_1.providerServices.getProviderMeals(providerId);
...
const updateOrderStatus = async (req, res) => {
    ...
    try {
        const result = await provider_services_1.providerServices.updateOrderStatus(orderId, status, userId);
...
const updateProvider = async (req, res) => {
    ...
    try {
        ...
        const result = await provider_services_1.providerServices.updateProvider(providerId, providerData);
...
exports.providerController = { updateProvider, getProviderOrders, getMyProviders, updateOrderStatus, getProviderMeals, createMeal, updateMeal, register, deleteMeal, getAllProviders };
